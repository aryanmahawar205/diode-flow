...
PROFILES: dict[tuple[str, str], TransferProfile] = {
    ("small",  "standard"):   TransferProfile(num_passes=2, overhead_ratio=0.50,
        rs_n=18, rs_k=2, interleave_depth=2, header_redundancy=3,
        window_size_bytes=16*1024*1024),
    ("small",  "critical"):   TransferProfile(num_passes=2, overhead_ratio=0.50,
        rs_n=20, rs_k=4, interleave_depth=3, header_redundancy=5,
        window_size_bytes=16*1024*1024),
    ("small",  "classified"): TransferProfile(num_passes=2, overhead_ratio=0.60,
